...
data_15m_qto1=read_complex_binary ("15m_qty_110mv_121_1.bin", 1000000,20023);
...
RSSI_15m_qt=mean(RSSI_15m_qt_f(1:500));
figure(5)
plot(angle_15m_qt_f)
...
distance_15m_qt=mean(diff_angel_15m_qt)/720*300; % Distance Estimation 0.0613
error_15m_qt=distance_15m_qt/15-1; %Estimation error is 0.0613
for j=1:120
