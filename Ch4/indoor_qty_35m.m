...
data_15m_qto1=read_complex_binary ("35m_qty_110mv_121_1.bin", 1000000,20023);
...
RSSI_35m_qt=mean(RSSI_15m_qt_f(1:500));
...
distance_35m_qt=mean(diff_angel_15m_qt)/720*300; % Distance Estimation 0.0613
error_35m_qt=distance_35m_qt/35-1; %Estimation error is 0.0613
for j=1:120
