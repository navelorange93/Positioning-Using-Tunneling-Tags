...
data_15m_qto1=read_complex_binary ("30m_qty_110mv_121_1.bin", 1000000,11557);
...
RSSI_30m_qt=mean(RSSI_15m_qt_f(1:500));
...
for k=5000:5500
    if angle_15m_qt_f(k)<=-80
        angle_15m_qt_f(k)=angle_15m_qt_f(k)+170;
    end
end
% for k=4500:5000
%     if angle_15m_qt_f(k)<=-80
...
distance_30m_qt=mean(diff_angel_15m_qt)/720*300; % Distance Estimation 0.0613
error_30m_qt=distance_30m_qt/30-1; %Estimation error is 0.0613
for j=1:120
